...
const navigationItems = [
  ...
  { name: "Regulatory Motif Analyzer", href: "/analyzer", icon: Search },
          ...
          {navigationItems.map((item) => {
            ...
            return (
              <Link
                key={item.name}
                href={item.href}
                className={`group flex items-center ${sidebarOpen ? 'gap-3 py-2.5 px-3' : 'justify-center py-3 px-2'} rounded-md hover:bg-slate-800 text-slate-400 hover:text-slate-100 transition-colors duration-200 relative`}
              ...
              <>
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <div className="truncate">
                    <p className="text-sm font-semibold text-slate-200 truncate">Researcher</p>
                    <p className="text-xs text-slate-500 truncate">Lab 04</p>
                  </div>
                </div>
